...
using MyMap = std::unordered_map<std::string, std::any>;


nb::list antsImageHeaderInfo( std::string fname )
{
  ...
  switch( pixelCode )
    ...
    nb::list info;
    info.append(pixelClass);
    info.append(pixeltype);
    info.append(numDimensions);
    info.append(numComponents);
