...
# install miniconda3
RUN wget --quiet https://repo.anaconda.com/miniconda/Miniconda3-py310_24.4.0-0-Linux-$(uname -m).sh \
    && /bin/bash Miniconda3-py310_24.4.0-0-Linux-$(uname -m).sh -b -p /opt/conda \
